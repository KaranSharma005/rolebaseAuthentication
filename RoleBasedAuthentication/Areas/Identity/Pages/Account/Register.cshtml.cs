        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(Input.Subject > 0 && Input.Subject <= 6 && User.IsInRole("Director"))
                    {
                        _helper.UpdateDetails(new TeacherSubjectModal
                        {
                            SubjectId = Input.Subject ?? 0,
                            Id = userId,
                            Name = Input.Name,
                            classId = Input.AvailClass
                        });
                    }

                    //_helper.assignClassToTeacher(userId,);
